...
#define UA_OPEN62541_VER_PATCH 7
#define UA_OPEN62541_VER_LABEL "-10-g7e4e0db5b" /* Release candidate label, etc. */
#define UA_OPEN62541_VER_COMMIT "v1.4.7-10-g7e4e0db5b"
#define UA_OPEN62541_VERSION "v1.4.7-10-g7e4e0db5b"
