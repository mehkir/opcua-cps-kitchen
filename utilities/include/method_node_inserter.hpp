...
private:
    std::vector<UA_Argument> input_arguments;
    std::vector<UA_Argument> output_arguments;
public:
    ...
    UA_StatusCode add_method_node(UA_Server* _server, std::string _method_node_id, std::string _browse_name, UA_MethodCallback _method_callback);
};
