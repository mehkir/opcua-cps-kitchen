...
UA_StatusCode node_value_subscriber::subscribe_node_value(UA_Client* _client, UA_NodeId _monitored_node_id, UA_Client_DataChangeNotificationCallback _notification_callback) {
    ...
    UA_MonitoredItemCreateResult monitor_response = UA_Client_MonitoredItems_createDataChange(_client, response.subscriptionId,
                                                    ...
                                                    NULL, _notification_callback, NULL);
