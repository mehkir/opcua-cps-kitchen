/**
 * @file object_type_node_inserter.hpp
 * @brief Facilities to build object type hierarchies, add methods/attributes, and create instances.
 */
...
/**
 * @brief Holds prepared input & output argument definitions for a method.
 */
struct method_arguments {
    private:
        std::vector<UA_Argument> input_arguments_; /**< the input arguments. */
        std::vector<UA_Argument> output_arguments_; /**< the output arguments. */

        /**
         * @brief Initializes an argument.
         * 
         * @param _description the description.
         * @param _name the name.
         * @param _type_index the type descriptor.
         * @param _argument the argument object to be initialized.
         */
    ...
    public:
        /**
         * @brief Constructs a new method arguments object.
         * 
         */
        method_arguments(){
        }
        ...
        /**
         * @brief Destroys the method arguments object.
         * 
         */
        ~method_arguments(){
        ...
        /**
         * @brief Adds or appends an input argument.
         * 
         * @param _description the description.
         * @param _name the name.
         * @param _type_index the type descriptor.
        ...
        /**
         * @brief Adds or appends an output argument.
         * 
         * @param _description the description.
         * @param _name the name.
         * @param _type_index the type descriptor.
         ...
         * 
         * @return std::vector<UA_Argument> the input arguments vector.
         */
         ...
         * 
         * @return std::vector<UA_Argument> the output arguments vector.
         */
...
/**
 * @brief High-level builder for object types and instances with attributes and methods.
 */
class object_type_node_inserter {
    private:
         ...
         */
        UA_StatusCode
        make_mandatory(UA_NodeId _node_id);
         ...
         */
        bool
        has_object_type(std::string _object_type_name);
         ...
         */
        UA_StatusCode
        find_child_node_id(std::string _instance_name, const char* _child_name, UA_NodeId& _node_id);
         ...
         */
        UA_StatusCode
        set_attribute(std::string _instance_name, const char* _attribute_name, UA_Variant& _value);
    ...
    public:
         ...
         */
        UA_StatusCode
        add_attribute(std::string _parent_object_type_name, const char* _attribute_name, bool _mandatory = true);
         ...
         */
        UA_StatusCode
        add_method(std::string _parent_object_type_name, const char* _method_name, UA_MethodCallback _method_callback, method_arguments& _method_arguments, void* _node_context, bool _mandatory = true);
         ...
         */
        UA_StatusCode
        add_object_sub_type(const char* _object_type_name);
         ...
         */
        UA_StatusCode
        add_object_instance(const char* _instance_name, const char* _type_name, UA_NodeId _parent_node_id = UA_NODEID_NUMERIC(0, UA_NS0ID_OBJECTSFOLDER), UA_NodeId _reference_type = UA_NODEID_NUMERIC(0, UA_NS0ID_ORGANIZES));
         ...
         */
        UA_NodeId
        get_object_type_id(std::string _object_type_name);
         ...
         */
        UA_NodeId
        get_instance_id(std::string _instance_name);
         ...
         * @param _attribute_name the attribute name.
         * @param _value the value.
         * @param _type_index the type descriptor index.
         * @return UA_StatusCode the status code.
         */
        UA_StatusCode
        set_scalar_attribute(std::string _instance_name, const char* _attribute_name, void* _value, UA_UInt32 _type_index);
         ...
         */
        UA_StatusCode
        set_array_attribute(std::string _instance_name, const char* _attribute_name, void* _array, size_t _array_size, UA_UInt32 _type_index);
         ...
         */
        UA_StatusCode
        get_attribute(std::string _instance_name, const char* _attribute_name, UA_Variant& _value);
};
