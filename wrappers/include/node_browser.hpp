/**
 * @file node_browser.hpp
 * @brief Functions to enumerate object types, instances, methods and attributes within a server address space.
 */
...
/**
 * @brief Provides browsing utilities for locating object types, objects, methods and attributes.
 */
class node_browser {
private:
public:
    /**
     * @brief Constructs a new node browser object.
     * 
     */
    node_browser();
    ~node_browser();
