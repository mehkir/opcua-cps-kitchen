...
int main(int argc, char* argv[]) {
    ...
    bool connected = con_estab.establish_connection(client, server_endpoint);
    if (!connected) {
    ...
    string_subscriber.subscribe_node_value(UA_NODEID_STRING(1, const_cast<char*>("str_node")), string_changed, &sample_data);
